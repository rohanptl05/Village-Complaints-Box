...
if (isset($_POST['search'])){
    ...
    $search = $_POST['search'];
    $sql = "SELECT * FROM users, complaints WHERE (firstname LIKE '%$search%' OR lastname LIKE '%$search%' OR phone LIKE '%$search%' OR username LIKE '%$search%' OR gender LIKE '%$search%') AND complaints.user_id = users.user_id";
